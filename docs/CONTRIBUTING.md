...
[create a proposal](https://github.com/zendframework/zend-jmap/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/zendframework/zend-jmap.git
  $ cd zend-jmap
  ```
...
2. Fork the repository (https://github.com/zendframework/zend-jmap)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/zend-jmap.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/zend-jmap.git
